...
public class MyDemoLoggingAspect {
	...
	@AfterThrowing(
			pointcut="execution(* adaydoner.demo.aop.dao.AccountDAO.find*(..))",
			throwing="exc")
	public void afterThrowingFindAccountAdvice(JoinPoint theJp, Throwable exc){
		String method = theJp.getSignature().toShortString();
		System.out.println("\n===>> Executing @AfterThrowing on advice : " + method);
		System.out.println("\n===>> Exception : " + exc);
	}
